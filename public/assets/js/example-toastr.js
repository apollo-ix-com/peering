(function(NioApp, $){
  ...
  $(".eg-toastr-bottom-center").on("click", function(e){
    e.preventDefault();
    toastr.clear();
    NioApp.Toast("This is a note for bottom center toast message.", "info", {position: "bottom-center"});
  });
  ...
  $(".eg-toastr-top-full").on("click", function(e){
    e.preventDefault();
    toastr.clear();
    NioApp.Toast("This is a note for top full width toast message.", "info", {position: "top-full"});
  });
  ...
  $(".eg-toastr-dark").on("click", function(e){
    e.preventDefault();
    toastr.clear();
    NioApp.Toast("This is dark version note of toast message.", "info", {ui: "is-dark"});
  });

  $(".eg-toastr-no-icon").on("click", function(e){
    e.preventDefault();
    toastr.clear();
    NioApp.Toast("This is without icon note of toast message.", "info", {icon: false});
  });
